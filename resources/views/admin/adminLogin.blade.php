        ...
        <form class="space-y-6 " method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="mb-6">
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    email</label>
                <input type="email" id="email" name="email" value={{ old('email') ? old('email') : 'awoke_admin@email.com' }}
                        ...
                        placeholder="awoke_admin@email.com">
                    @error('email')
                        <span>
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password"
                        class="bg-pr-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pr-500 focus:border-pr-500 block w-full p-2.5 "
                        placeholder="Demo for test: 12345678" value="12345678" name="password">
                    @error('password')
                        <span>
